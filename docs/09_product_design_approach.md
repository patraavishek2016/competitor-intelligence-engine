...
### Customer
* **Who**: Product Managers, Product Owners, Strategy Analysts, Startup Founders.
...
* **What Success Looks Like**: Automated sweep of competitor URLs that returns verifiable, structured SWOT metrics and downloadable briefs.
